...
{
    { BOX2_SOURCE_WIDTH, BOX2_SOURCE_HEIGHT, 30 },
};
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"BOX-2 Wi-Fi Display";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"BOX-2 Project";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"ESP32-S3 RGB565 LCD";
...
void IndirectDeviceContext::FinishInit(UINT ConnectorIndex)
{
    ...
    if (FAILED(CoCreateGuid(&MonitorInfo.MonitorContainerId)))
    {
        return;
    }
...
NTSTATUS IddSampleMonitorQueryModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_QUERYTARGETMODES* pInArgs, IDARG_OUT_QUERYTARGETMODES* pOutArgs)
{
    ...
    TargetModes.push_back(CreateIddCxTargetMode(BOX2_SOURCE_WIDTH,
                                                BOX2_SOURCE_HEIGHT, 30));
